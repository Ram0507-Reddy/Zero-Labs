        ...
        <motion.form variants={itemVars} onSubmit={handleSubmit} className="space-y-8">
          ...
          <motion.div variants={itemVars} className="pt-8">
            <button 
              ...
              className="group relative w-full md:w-auto px-12 py-4 bg-white text-black font-semibold tracking-wide overflow-hidden disabled:opacity-50"
            >
            ...
            {status === 'success' && (
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 text-sm text-white font-mono">
                [SUCCESS] Transmission received. We will respond shortly.
              </motion.p>
            )}
            
            {status === 'error' && (
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 text-sm text-red-500 font-mono">
